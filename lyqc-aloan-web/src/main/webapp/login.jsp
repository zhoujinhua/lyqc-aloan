...
<html>
  <head>
    ...
    <script type="text/javascript" src="static/weblib/bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="static/weblib/bootstrap/js/carousel.js"></script>
    ...
    <body class="page page-hybird">
    	<div class="log_header header">
			<div class="container">
                <img class="logo" src="static/image/logo-x1.png" style="height:65px;">
            </div>
		</div>
		<div class="content">
			<div class="wrap af3">
				<div style="z-index: 10000; position: absolute; top: 0px; right: 80px" class="login_con">
				 ...
				 <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				      ...
				      <div class="carousel-inner" role="listbox">
				        <div class="active item"><img style="height:auto;" alt="" src="static/image/img1.png"></div>
				        <div class="item"><img style="height:auto;" alt="" src="static/image/img2.jpg"></div>
				      </div>
			     </div>
			</div>
