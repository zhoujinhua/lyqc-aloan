	    ...
	    <div class="row">
	    	<div class="box col-md-12">
		      	<div class="box-inner">
		           ...
		           <div class="box-content">
		           		<cs:table id="data-table" class="table table-striped table-bordered responsive" onrender="${path }/dealercompany/list">
	           				<cs:column dataField="companyName" name="单位名称"></cs:column>
	           				<cs:column dataField="companyCode" name="单位编码"></cs:column>
	           				<cs:column dataField="companyType" name="单位类型" type="dict" format="_dealer_type"></cs:column>
	           				<cs:column dataField="saleArea" name="销售区域" type="dict" format="_sale_area"></cs:column>
	           				...
	           				<cs:column dataField="companyCode" name="操作" renderFn="operator"></cs:column>
		           		</cs:table>
		           </div>
		       </div>
	       </div>
