...
<div class="ch-container">
    <div class="row">
        ...
        <div id="content" style="float:right;width:84%;">
        	...
        	<iframe id="sub-content" onreadystatechange=stateChangeIE(this) onload=stateChangeFirefox(this) src="${path }/view/welcome.jsp?juid=${juid}" style="width: 100%;height: 96%;border:none;" frameborder="0"></iframe>
    	</div>
	</div>
</div>
</body>
