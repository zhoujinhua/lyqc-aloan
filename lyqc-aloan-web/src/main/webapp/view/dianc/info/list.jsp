...
<body>
	<script type="text/javascript">
		function operator(data, type, full, meta){
			var html = '';
	    	html += ' <a href="'+ contextPath +'/dianc/detail?appCode='+data+'">'+ data +'</a>';
	    	return	data=html;
		}
		$(function(){
	...
	<div class="ch-container">
	    <ul class="breadcrumb">
	        ...
	        <li>
	            <a href="${path }/view/dianc/info/list.jsp">逾期客户查询</a>
	        </li>
	    </ul>
		<div class="row">
		           ...
		           <div class="box-content">
		           		<form id="fn-search-form" class="form-horizontal" method="post" >
	                    	...
	                    	<div class="form-group">
		                        ...
		                        <div class="col-sm-3">
		                        	<cs:select class="form-control" type="region" name="liveProvince" id="live-province" renderId="data-table"/>
		                        </div>
		                        <label class="control-label col-sm-1">所在城市</label>
		                        <div class="col-sm-3">
		                        	<cs:select class="form-control" type="region" name="liveCity" provinceId="live-province" renderId="data-table"/>
		                        </div>
		                     </div>
	                    	<div class="form-group">
		                        ...
		                        <label class="control-label col-sm-1">催收区间</label>
		                        <div class="col-sm-3">
		                        	<cs:select class="form-control chosen" dicField="_overdue_range" name="overdueRange" allowBlank="true" renderId="data-table"/>
		                        </div>
	                    	...
	                    	<div class="form-group">
		                        ...
		                        <div class="col-sm-3">
		                        	<cs:select class="form-control chosen" dicField="_is" name="isCurrOverdue" allowBlank="true" renderId="data-table"/>
		                        </div>
