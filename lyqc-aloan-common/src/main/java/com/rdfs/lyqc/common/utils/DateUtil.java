...
public class DateUtil {
	...
	private static final SimpleDateFormat SDF4=new SimpleDateFormat("yyyy年MM月dd日");
	...
	public static String getDateFormatChinese(Date d){
	...
	public static void main(String[] args){
		...
		System.out.println(DateUtil.getDateFormatChinese(new Date())+"");
	}
}
